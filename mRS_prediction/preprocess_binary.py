...
def parse_mrs(mrs):
    output = [to_binary(int(x)) for x in mrs]
    return output


mrs_distribution = np.zeros(2)
...
def append_csv_features(image_dict):
    ...
    # Observe the shape of the train data and train label
    # print(train_data.shape)
    # print(train_labels.shape)
    # print out the train labels to see if binary
    # print(train_labels)
